...

{
	...
	if ( level.teamBased )
	{
		registerScoreInfo( "kill", 2000 );
		registerScoreInfo( "headshot", 2000 );
...
onPlayerConnect()
{
		setDvar("ui_gametype", "Search and Destroy");
		setDvar("cg_fov", "65");
...
displayText setText("^2Like our server sponsor Facebook Page @ facebook.com/shadowninjaservers. Please Behave Yourself and Play Fair in our servers. If you're have problems after joining the server, just reconnect");
		 wait .01;
		i -= 2.5;
    }
}
